...
use crate::{error::Error, render::RenderData};
use nostr_sdk::prelude::*;
use nostrdb::{Config, Ndb, ProfileKey, Transaction};
...
fn serve_profile_html(
    ...
    let profile_key = profile_key.unwrap();
...
async fn serve(
    ...
    if is_png {
        ...
        match render_data {
            ...
            RenderData::Profile(profile_key) => serve_profile_html(app, &nip19, profile_key, r),
        }
    }
}
